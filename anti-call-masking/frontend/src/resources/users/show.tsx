        ...
        <Col xs={24} lg={8}>
          <Card bordered={false}>
            ...
            <Space direction="vertical" style={{ width: '100%' }} size={12}>
              <div>
                <Space>
                  <MailOutlined style={{ color: ACM_COLORS.textSecondary }} />
                  <Text>{user.email}</Text>
                </Space>
              </div>
              <div>
                <Space>
                  <CalendarOutlined style={{ color: ACM_COLORS.textSecondary }} />
                  <Text type="secondary">
              ...
              <div>
                <Space>
                  <SafetyCertificateOutlined style={{ color: ACM_COLORS.textSecondary }} />
                  <Text type="secondary">
                    {user.is_active ? (
