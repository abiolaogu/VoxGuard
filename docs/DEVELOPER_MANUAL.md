...
6. [GitHub Copilot Workspace Agent](#-github-copilot-workspace-agent)
7. [The Rules: Tiered Autonomy](#-the-rules-tiered-autonomy)
8. [Manual Override & Troubleshooting](#-manual-override--troubleshooting)
...
Think of Copilot as another AI agent in your factory assembly line—one that works directly in your GitHub issues and automates code implementation tasks.

### Configuration

**File:** `.github/copilot-setup-steps.yml`

This configuration defines how Copilot validates its work before submitting PRs. It ensures:

- **Dependencies are installed** correctly
- **Tests pass** before submitting changes
- **Code formatting** follows project standards (Black)
- **Linting rules** are satisfied (Flake8)
- **Type checking** validates code correctness (MyPy)
...
validate:
  - name: Validate Project Structure
    run: test -f requirements.txt && test -d src/
```
...
Create a new issue or comment on an existing one with a clear description:
...
#### 3. Copilot Validates Before Submitting

Before opening a PR, Copilot automatically runs all validation steps defined in `.github/copilot-setup-steps.yml`. If any step fails, Copilot will fix the issues before submitting.
...
### Copilot vs. Claude Code Action

**When to Use Copilot:**
- Quick feature implementations (< 100 lines)
- Bug fixes with clear reproduction steps
- Test additions
- Documentation updates
- Code refactoring

**When to Use Claude Code Action:**
...
**Best Practice:** Use both! Let Copilot handle tactical coding tasks while Claude Code Action handles strategic factory operations.
...
- [Copilot Usage Guide](./COPILOT_USAGE.md) - Detailed Copilot documentation
...
# Delegate task to Copilot (via GitHub issue)
gh issue create \
  --title "Add new feature" \
  --body "@copilot Implement X feature with Y requirements"

# Comment on existing issue to trigger Copilot
gh issue comment 123 \
  --body "@copilot Fix the bug in file.py line 45"
...
| `.github/copilot-setup-steps.yml` | Copilot validation configuration |
...
| `docs/COPILOT_USAGE.md` | Detailed Copilot usage guide |
...
- **Copilot Usage Guide:** `docs/COPILOT_USAGE.md` - Comprehensive GitHub Copilot Workspace Agent guide
...
- **Factory Constitution:** `CLAUDE.md` - Complete operating rules
- **GitHub Copilot Workspace:** [Official Documentation](https://docs.github.com/en/copilot/using-github-copilot/using-github-copilot-workspace)
