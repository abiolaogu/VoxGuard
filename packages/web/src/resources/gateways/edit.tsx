...
export const GatewayEdit: React.FC<IResourceComponentsProps> = () => {
  const { formProps, saveButtonProps, queryResult } = useForm<IGateway>();
    ...
    <Edit saveButtonProps={saveButtonProps}>
      <Form {...formProps} layout="vertical">
        <Card title="Basic Information" style={{ marginBottom: 16 }}>
          ...
          >
            <Input placeholder="e.g., GTW-NG-MTN-LAG-01" disabled />
          </Form.Item>
        ...
        <Card title="Status & Health" style={{ marginBottom: 16 }}>
          <Form.Item
            label="Status"
            name="status"
            rules={[
          ...
          <Form.Item
            ...
            shouldUpdate={(prevValues, currentValues) =>
              prevValues.is_blacklisted !== currentValues.is_blacklisted
            }
          >
            {({ getFieldValue }) =>
              getFieldValue('is_blacklisted') ? (
                <Form.Item
                ...
                >
                  <TextArea rows={3} placeholder="Reason for blacklisting this gateway" />
                </Form.Item>
              ) : null
            }
          </Form.Item>
