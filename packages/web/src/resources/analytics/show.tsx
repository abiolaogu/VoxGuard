...
export const AnalyticsPage: React.FC = () => {
  ...
  const severityData = useMemo(() => {
    ...
    return [
      { type: 'Critical', value: counts.CRITICAL, color: VG_COLORS.critical },
      { type: 'High', value: counts.HIGH, color: VG_COLORS.high },
      { type: 'Medium', value: counts.MEDIUM, color: VG_COLORS.medium },
      { type: 'Low', value: counts.LOW, color: VG_COLORS.low },
  ...
  const trafficChartConfig = {
    ...
    seriesField: 'type',
    height: 300,
    color: [VG_COLORS.primaryLight, VG_COLORS.critical],
    smooth: true,
  ...
  const severityPieConfig = {
    ...
    innerRadius: 0.6,
    height: 250,
    color: [VG_COLORS.critical, VG_COLORS.high, VG_COLORS.medium, VG_COLORS.low],
    label: {
      type: 'inner',
      offset: '-50%',
      content: '{value}',
        ...
        <Col xs={12} sm={6}>
          <Card bordered={false} className="acm-stats-card">
            <Statistic
              ...
              prefix={<AlertOutlined style={{ color: VG_COLORS.primary }} />}
            />
          </Card>
        </Col>
        <Col xs={12} sm={6}>
          <Card bordered={false} className="acm-stats-card">
            <Statistic
              ...
              valueStyle={{ color: criticalCount > 0 ? VG_COLORS.critical : undefined }}
              prefix={<SafetyCertificateOutlined style={{ color: VG_COLORS.critical }} />}
            />
          </Card>
        </Col>
        <Col xs={12} sm={6}>
          <Card bordered={false} className="acm-stats-card">
            <Statistic
              ...
              value={2.8}
              suffix="%"
              prefix={<RiseOutlined style={{ color: VG_COLORS.success }} />}
            />
          </Card>
        </Col>
        <Col xs={12} sm={6}>
          <Card bordered={false} className="acm-stats-card">
            <Statistic
              ...
              value={4.2}
              suffix="min"
              prefix={<PhoneOutlined style={{ color: VG_COLORS.info }} />}
            />
          </Card>
        </Col>
      </Row>
